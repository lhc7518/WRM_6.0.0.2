/*amd /ui/SP/advancedfileUpload.xml 50917 9a000a8178418f7adfc0d21b7f8552a9ebc45ef42d7bd6c8fec754d283ee9384 */
define({declaration:{A:{version:'1.0',encoding:'UTF-8'}},E:[{T:1,N:'html',A:{xmlns:'http://www.w3.org/1999/xhtml','xmlns:ev':'http://www.w3.org/2001/xml-events','xmlns:w2':'http://www.inswave.com/websquare','xmlns:xf':'http://www.w3.org/2002/xforms'},E:[{T:1,N:'head',E:[{T:1,N:'w2:type',E:[{T:3,text:'DEFAULT'}]},{T:1,N:'w2:buildDate'},{T:1,N:'xf:model',E:[{T:1,N:'w2:dataCollection',A:{baseNode:'map'}},{T:1,N:'w2:workflowCollection'}]},{T:1,N:'style',A:{type:'text/css'},E:[{T:4,cdata:'.none{display:none}.block{display:block}.exup_wrap{width:444px;min-height:106px;border:1px solid #b3b3b3}.exup_header{height:27px}.exup_header .title{padding-left:28px;font-weight:700;line-height:23px}.exup_header .title2{padding-left:28px;font-weight:700;line-height:23px;float:left}.exup_header span{padding-right:20px;float:right;display:block}.exup_header span input[type=checkbox]{position:relative;top:1px}.exup_spanGroup{background-color:transparent}.exup_content{padding:15px 10px 12px}.exup_content .filebox{padding:8px 0 0 11px;width:408px;height:33px;border:1px solid #d3d3d3;background:#f6f6f6}.exup_content .filebox span{display:inline-block;width:300px;height:21px;font-family:Verdana;font-size:12px;background:#fff}.exup_tbl{margin:15px auto 0;width:400px}.exup_tbl th,.tbl td{min-width:100px;height:24px;text-align:left}.exup_tbl th .dot{padding-left:14px}.exup_tbl td .ipt{width:74px;height:16px}.exup_tbl td .sel{width:80px;height:20px}.btn_exup_file{margin-bottom:14px;width:90px;position:relative;left:333px;border-radius:4px}.none{display:none}.block{display:block}.exup_wrap{width:444px;min-height:106px;border:1px solid #b3b3b3}.exup_header{height:27px}.exup_header .title{padding-left:28px;font-weight:700;line-height:23px}.exup_header .title2{padding-left:28px;font-weight:700;line-height:23px;float:left}.exup_header span{padding-right:20px;float:right;display:block}.exup_header span input[type=checkbox]{position:relative;top:1px}.exup_spanGroup{background-color:transparent}.exup_content{padding:15px 10px 12px}.exup_content .filebox{padding:8px 0 0 11px;width:408px;height:33px;border:1px solid #d3d3d3;background:#f6f6f6}.exup_content .filebox span{display:inline-block;width:300px;height:21px;font-family:Verdana;font-size:12px;background:#fff}.exup_tbl{margin:15px auto 0;width:400px}.exup_tbl th,.tbl td{min-width:100px;height:24px;text-align:left}.exup_tbl th .dot{padding-left:14px}.exup_tbl td .ipt{width:74px;height:16px}.exup_tbl td .sel{width:80px;height:20px}.btn_exup_file{margin-bottom:14px;width:90px;position:relative;left:333px;border-radius:4px}.exup_fileupload .exup_wrap{width:100%;padding:19px;border:0;box-sizing:border-box}.exup_fileupload .exup_header{height:24px;margin-bottom:4px;background:var(--ws-gray-0)!important}.exup_fileupload .exup_header .title{display:none}.exup_fileupload .exup_header .title2{font-size:14px}.exup_fileupload .exup_header span{display:block;float:right;padding-right:0}.exup_fileupload .exup_header span input[type=checkbox]{top:0;width:16px;height:16px}.exup_fileupload .exup_content{padding:0}.exup_fileupload .exup_content .filebox{display:flex;align-items:center;width:100%;height:auto;padding:8px;border:1px solid var(--ws-gray-300);background:var(--ws-gray-50);box-sizing:border-box}.exup_fileupload .exup_content .filebox .w2trigger{flex:none;height:30px!important;border:1px solid var(--ws-btn-bd);border-radius:var(--ws-btn-radius);background:var(--ws-btn-bg);font-size:13px}.exup_fileupload .exup_content .filebox .fileName{display:flex;flex:1;align-items:center;height:30px;margin-left:4px;padding:0 4px;border:1px solid var(--ws-form-bd);border-radius:var(--ws-form-radius);background:var(--ws-gray-0);font-size:13px;box-sizing:border-box}.exup_fileupload .foot{margin-top:16px}.exup_fileupload .foot>p{position:relative;text-align:right}.exup_fileupload .foot .btn_exup_file{left:auto;width:auto;height:36px;margin-bottom:0;padding:0 12px;border-radius:var(--ws-btn-radius)}.exup_fileupload .exup_tbl{position:relative;width:100%;margin-top:12px;border-collapse:collapse}.exup_fileupload .exup_tbl th{height:30px;padding:4px 0;border:1px solid var(--ws-table-bd);background:var(--ws-table-th-bg);background-clip:padding-box;text-align:left;word-break:break-word}.exup_fileupload .exup_tbl th .w2span,.exup_fileupload .exup_tbl th .w2textbox{display:inline-block;position:relative;vertical-align:middle}.exup_fileupload .exup_tbl td{height:30px;padding:6px;border:1px solid var(--ws-table-bd);background:var(--ws-table-td-bg);background-clip:padding-box;word-break:break-word}.exup_fileupload .exup_tbl td .ipt,.exup_fileupload .exup_tbl td .sel,.exup_fileupload .exup_tbl td .w2selectbox_select{width:100%;height:30px}.exup_fileupload .exup_tbl th .dot{padding-left:10px;background:0 0!important}.exup_fileupload .exup_tbl td .sel,.exup_fileupload .exup_tbl td .w2selectbox{background:var(--ws-form-bg) url(/cm/images/base/ico_select.svg) no-repeat right 6px center}'}]},{T:1,N:'script',A:{type:'text/javascript',lazy:'false'},E:[{T:4,cdata:function(scopeObj){with(scopeObj){window.WebSquare.excelUploadUUID = $p.getFrameId();
scwin.sizeInfo = {};
scwin.osName = "";
scwin.vActionUrl = "";
...
scwin.onpageload = function () {
  ...
  try {
    ...
    bul_title.render.innerHTML = scwin.Upload_file;
