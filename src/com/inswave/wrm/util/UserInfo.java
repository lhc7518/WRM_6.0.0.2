...
public class UserInfo implements Serializable {
	...
	// MODE_TYPE - 메인화면 Style
	private String mainStyleCode;

	// Default 설정
	@Value("${main.setting.default.style}")
	private String defaultMainStyleCode;
	...
	public String getMainStyleCode() {
		return mainStyleCode;
	}

	public void setMainStyleCode(String mainStyleCode) {
		if(mainStyleCode == null || mainStyleCode.equals("")) {
			this.mainStyleCode = this.defaultMainStyleCode;
		}else {
			this.mainStyleCode = mainStyleCode;	
		}
	}

	public String getDefaultMainStyleCode() {
		return this.defaultMainStyleCode;
	}
	...
	public Map<String, Object> getUserInfo() {
		...
		userInfo.put("MODE", this.getMainStyleCode());
		return userInfo;
	}
	...
	public void setUserInfo(HttpSession session) {
		...
		this.setMainStyleCode((String) session.getAttribute("MODE_TYPE"));
	}
	...
	public void updateMainLayoutCode(HttpSession session, String mainLayoutPageCode) {
		...
		session.setAttribute("MODE_TYPE", this.getMainStyleCode());
	}
	...
	public void setUserInfo(Map memberInfo) {
		...
		this.setMainStyleCode((String) memberInfo.get("MODE_TYPE"));
	}
